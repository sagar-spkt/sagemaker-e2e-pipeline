...
if __name__ == "__main__":
    ...
    none_or_int = lambda arg: None if arg.lower() == "none" or arg.lower() == "null" else int(arg)
    ...
    parser.add_argument("--max-depth", type=none_or_int, default=None)
    parser.add_argument("--min-samples-split", type=int, default=2)
    parser.add_argument("--min-samples-leaf", type=int, default=1)
    parser.add_argument("--max-features", type=none_or_str, choices=["sqrt", "log2", None], default="sqrt")
    parser.add_argument("--bootstrap", type=bool, default=True)
    parser.add_argument("--oob-score", type=bool, default=True)
